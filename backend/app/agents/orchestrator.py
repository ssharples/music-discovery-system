...
# Temporarily disabled to prevent pydantic-ai blocking issues:
...
class DiscoveryOrchestrator:
    ...
    def __init__(self):
        ...
        logger.info("✅ Orchestrator initialized with YouTube agent (others disabled to prevent blocking)")
